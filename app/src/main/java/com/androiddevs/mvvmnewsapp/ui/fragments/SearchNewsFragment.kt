...
import com.androiddevs.mvvmnewsapp.utils.Utils.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment: Fragment(R.layout.fragment_search_news) {
            ...
            when(response){
                is Resource.Success ->{
                    ...
                    response.data?.let {newsReponse ->
                        ...
                        val totalPages = newsReponse.totalResults / Utils.QUERY_PAGE_SIZE + 2
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            var isNotAtBeginning = firstVisibleItemPosition >= 0
            var isTotalMoreThanVisible = totalItemCount >= Utils.QUERY_PAGE_SIZE
            var shouldPaginate = isNotLoadingAndNotLastPage && isAtLastItem && isNotAtBeginning && isTotalMoreThanVisible && isScrolling
